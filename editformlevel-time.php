   ...
   <div class="row">
     ...
     <form class="form-horizontal" action="action/editlevel-time.php?id=<?php echo $id;?>" method="post">
       <div class="form-group">
              <label for="level_id" class="col-sm-4 control-label">ลำดับ</label>
            <div class="col-sm-3">
      ...
      <div class="form-group">
             <label for="name" class="col-sm-4 control-label">ชื่อของแต่ละ Level</label>
           <div class="col-sm-3">
             <input type="name" class="form-control" id="name" name="name" value="<?php echo $row["name"]; ?>" placeholder="name">
           </div>
     </div>
      <div class="form-group">
             <label for="hidden_char" class="col-sm-4 control-label">จำนวนคำที่ซ่อน</label>
           <div class="col-sm-3">
     ...
     <div class="form-group">
            <label for="number_answer" class="col-sm-4 control-label">จำนวนคำที่ต้องตอบถูกของ Level</label>
          <div class="col-sm-3">
    ...
    <div class="form-group">
           <label for="test" class="col-sm-4 control-label">จำนวนคำที่ต้องตอบถูกหน้า TestLevel</label>
         <div class="col-sm-3">
        <input type="test" class="form-control" id="test" name="test" value="<?php echo $row["test"]; ?>" placeholder="Test">
         </div>
   </div>
    <div class="form-group">
          <label for="second" class="col-sm-4 control-label">เวลาของแต่ละ Level</label>
        <div class="col-sm-3">
       <input type="number" min="10" class="form-control" id="test" name="second" value="<?php echo $row["second"]; ?>" placeholder="Second">
        </div>
      </div>
