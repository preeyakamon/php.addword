...
if ($level != null || $name != null || $hidden != null || $number != null || $second != null ) {
    $sql = "UPDATE level SET  hidden_char = '$hidden', name = '$name', number_answer = '$number', second = '$second' WHERE level_id = $level";
